...
E8 — [Paper milestone evidence bundle, revision 2](https://drive.google.com/file/d/1fO_WnFmWJ4MKFaKJ16m5TOJ-agizGTzN/view), shared with Taj as reader. Archive SHA256: `efe5e93b82e5d3b74a4b959dd061695f0f07fd0abd8ed27d301c5bf1ee25e28c`. E9 is the proposed pilot package linked above. The [September 11 production record](PRODUCTION_2026-09-11.md) identifies the deployed revision and verification.
...
E10 — Continuous paper service guide and frozen protocol. E11 — Adversarial fixes and recovery evidence. Verification passed: 150 backend tests, 52 tests in the dedicated paper runtime, and 10 relay tests including actual isolated Redis execution. Real Upstash delivery is now verified; the dated relay activation record supplements the earlier recovery evidence.
...
The shareable production website now receives automatic worker reports through Upstash Redis on the free plan, with automatic upgrades disabled. Real integration checks passed: unauthorized writes return 401, duplicate retries are safe, older reports return 409, and successive fresh reports reach the desktop and mobile dashboard. The same registered run and both flat simulated $50,000 accounts were preserved. Prices, private ledgers and credentials stay off the public site.

Next: verify entitlements, provision a persistent host, and prove off-host backup/restore and independent alerts. The Mac remains vulnerable to lid closure, power and network loss. Count complete opportunities and market conditions; twenty opportunities prompts engineering review, not profit validation. All six live-pilot requirements remain unverified, including an actual broker adapter and separate real-money authorization.
...
E13 — [Real production relay activation](https://tajari.vercel.app/evidence/continuous-paper-relay.json). Dated API and automatic-publication checks; original registration and balances preserved. This adds shared visibility, not cloud-worker continuity or a trading result.
